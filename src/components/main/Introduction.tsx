...
const Introduction:React.FC = () => {
  return (
    <div className='flex flex-col items-center gap-4 sm:gap-8 py-4'>
      <div className='flex flex-col 2xl:flex-row justify-center items-center sm:gap-4 2xl:px-10'>
        <div>
          <p className='text-mygreen font-mytitlefont text-2xl sm:text-4xl font-bold tracking-wider text-center py-2 sm:py-4 2xl:pb-6'>Air Pollutants</p>
          <p className='text-center text-lg sm:text-2xl text-slate-900 tracking-wider px-4 sm:px-6'>
        ...
        <img src={introduction1} alt="introduction1" className='h-52 sm:h-72 sm:w-3/5 2xl:w-2/5 p-4 rounded-3xl'/>
      </div>
      <div className='flex flex-col 2xl:flex-row-reverse justify-center items-center sm:gap-4 2xl:px-10'>
        <div>
          <p className='text-mygreen font-mytitlefont text-2xl sm:text-4xl font-bold tracking-wider text-center py-2 sm:py-4'>Pollutant Classification</p>
          <p className='text-center text-lg sm:text-2xl text-slate-900 tracking-wider px-4 sm:px-6'>
        ...
        <img src={introduction2} alt="introduction2" className='h-52 sm:h-72 sm:w-3/5 2xl:w-2/5 p-4 rounded-3xl'/>
      </div>
      <div className='flex flex-col 2xl:flex-row justify-center 2xl:justify-between items-center sm:gap-4 2xl:w-full 2xl:px-10'>
        <div>
          <p className='text-mygreen font-mytitlefont text-2xl sm:text-4xl font-bold tracking-wider text-center py-2 sm:py-4 2xl:pb-6'>Research & Sustainability</p>
          <p className='text-center text-lg sm:text-2xl text-slate-900 tracking-wider px-4 sm:px-6'>
